...
import { StyleSheet, Text, View, ImageBackground, Image, TextInput, TouchableOpacity, Button, ScrollView } from 'react-native';
...
export default function AddItem() {
  ...
  return (
    <ImageBackground style={styles.BackDrop} source={require('./assets/backdrop03.png')}>
      <ScrollView>
